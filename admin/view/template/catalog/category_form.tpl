            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-new_field<?php echo $language['language_id']; ?>"><?php echo $entry_new_field; ?></label>
                    <div class="col-sm-10">
                      <textarea name="category_description[<?php echo $language['language_id']; ?>][new_field]"  rows="5" placeholder="<?php echo $entry_new_field; ?>" id="input-new_field<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['new_field'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
